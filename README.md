# 세상의 모든 지식 
- [세상의 모든 지식](#---------)
  * [2장. 정보를 수집하고 활용하는 새로운 방법 - CahtGPT 플러그인](#2-------------------------cahtgpt-----------)
  * [3장. 만능 작업 도우미 - GPT-4 Analysis](#3--------------gpt-4-analysis)
  * [4장. DeepL & Whisper로 세상의 모든 정보 활용하기](#4--deepl---whisper----------------)
  * [5장 구글 문서에서 ChatGPT 사용하기](#5----------chatgpt-----)
  * [6장. 바로바로 사용이 가능한 디자인 하기 - DALL-E](#6------------------------dall-e)
  * [7장. 회사에서 사용할 업무용 챗봇 만들기 - GPTs](#7----------------------------------------gpts)
&nbsp;
&nbsp;
&nbsp;
&nbsp;
